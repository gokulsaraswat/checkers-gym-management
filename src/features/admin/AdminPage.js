        ...
        <>
          ...
          <Stack spacing={1.5} mb={4}>
            ...
            <Typography color="text.secondary" maxWidth="920px">
              ...
              suspend or reactivate accounts, maintain staff roles, launch the pricing catalog, open the finance export center, run the POS and inventory desk, review owner-ready reports, and keep the CRM lead pipeline moving every day.
            </Typography>
